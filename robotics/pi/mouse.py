...
while(1):
	...
	if debug:
		print l,m,r,x,y
	if flag==1:
		#If left or right mouse not pressed, move forward
		# fwd()
		print('go forward')
		flag=0
	if l:
		#If left mouse buton pressed, turn left
		# left()
		print('turn left')
		flag=1
	if m:
		#If middle mouse button pressed, stop
		# stop()
		print('stop')
	if r:
		#If right mouse button presses, turn right
		# right()
		print('turn right')
		flag=1
	if l and r:
		#If both the left and right mouse buttons pressed, go back
		# bwd()
		print('go back')
