# listen for sound and transfer to text
...
def stt_google_wav(audio_fname):
    ...
    if 'flac' not in filename:
        ...
        output_file = filename.split('.')[0] + '.flac'
        ff = ffmpy.FFmpeg(
            executable='D:\Software/ffmpeg/bin/ffmpeg.exe',
        ...
        filename = output_file # filename.split('.')[0] + '.flac'
